...
| `extract_text` | bool | `true` | Extract each page's text. `false` is structure only: pages are still produced, with none of their content blocks. Independent of `extract_resources`. |
